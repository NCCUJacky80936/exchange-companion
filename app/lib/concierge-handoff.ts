...
const editableSurfaces: HandoffSurface[] = [
  ...
  { id: "resource-intake", statePath: "state.resourceIntake[]", proposalEntity: "resource-intake", privacy: "private", fields: ["url", "note", "status", "createdAt"], notes: "pending URL 只授權處理該網址，不授權擴大掃描；完成前必須交叉檢查任務、資源、預算、行李、航班、課程與旅行欄位，不能只建立書籤。" },
