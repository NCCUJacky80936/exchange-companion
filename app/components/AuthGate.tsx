  ...
  if (view === "welcome") return (
    <main className="welcome-shell">
      ...
      <section className="welcome-hero">
        ...
        <div className="welcome-art"><Image src="/images/exchange-hero-clean.png" alt="手繪交換旅行行李與路線插畫" width={520} height={296} /></div>
      </section>
      <section className="welcome-features" aria-label="主要功能"><article><Image src="/images/doodle-icons-v2/journey-route.png" alt="" width={72} height={72} /><h2>一條交換路線</h2><p>從錄取、簽證、住宿到返國，期限與阻塞狀態集中追蹤。</p></article><article><Image src="/images/doodle-icons-v2/ai-spark.png" alt="" width={72} height={72} /><h2>AI 幫你補齊</h2><p>讀取你授權的信件、文件與網址，產生可逐項審核的更新。</p></article><article><Image src="/images/doodle-icons-v2/travel-suitcase.png" alt="" width={72} height={72} /><h2>行李與旅行一起看</h2><p>核對本人機票額度，並檢查旅行是否撞到上課或考試。</p></article></section>
    </main>
  );
